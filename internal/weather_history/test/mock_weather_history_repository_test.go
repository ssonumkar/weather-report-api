...
func (m *MockSuccessWeatherHistoryRepository) GetWeatherSearchHistory(logger log.CustomLogger) ([]weatherhistory.WeatherHistory, error) {
...
func (m *MockFailWeatherHistoryRepository) GetWeatherSearchHistory(logger log.CustomLogger) ([]weatherhistory.WeatherHistory, error) {
